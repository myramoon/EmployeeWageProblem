/* PURPOSE: Calculates and saves total wages for multiple companies  using instance variables */
...
public class EmployeeWageBuilder {
	...
	public static void main(String[] args) {
		...
		//Call method "computeWage" that computes monthly wages for companies for these objects
